...
<head>
  ...
  <title>Family Income | Our History</title>
  ...
  <main id="main">
    ...
    <section id="featured-members" class="featured-members">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="{{asset('frontend')}}/assets/img/members/featured-members-2.jpg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-lg-6">
            <img src="{{asset('frontend')}}//img/members/featured-members-3.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-3 pt-lg-0">
        ...
        <div class="row content">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="{{asset('frontend')}}/assets/img/members/featured-members-4.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 order-2 order-lg-1 pt-3 pt-lg-0">
